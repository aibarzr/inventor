...
<div class="container-fluid">
    <div class="container">
           ...
           <div id="formcontainer" style="margin-top:200px">
                <div class="row">
                        <div class="col"><h5>PROVEEDORES</h5></div>
                        <div class="col"></div>
                </div>
<?php
    $mar=$_POST['marcas'];
    ...
    $sql="SELECT mp.*, p.* FROM marcaproveedor as mp, proveedores as p WHERE p.idproveedor=mp.idproveedor AND mp.idmarca=$mar;";
...
<br>
            <div class="row">
                        <div class="col">
                            <a href="ver-buscarmarcasproveedor.php"><input type="button" class="btn" value="Nueva busqueda"></a>
                        </div>
                        <div class="col">
