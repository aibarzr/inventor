    ...
    ?>
        <div class="container">
            ...
            <div id="formcontainer">
                <form name="marcas" id="marcas" method="post" action="ins-marcas.php">
                    <div class="row">
                        <div class="col" style = "font-size: 20px">MARCA:</div>
                        <div class="col"><input type="text" name="marca" id="marca" style = "height: 30px; width: 100%"></div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col" style = "font-size: 20px">PROVEEDORES DE LA MARCA:</div>
                        <div class="col">
                                    ...
                                    <?php
                                        ...
                                        while($linea=mysqli_fetch_array($registros)){
                                            echo"<label style = \"height: 30px; width: 100%\"><input type='checkbox' name='proveedores[]' value='$linea[idproveedor]'>$linea[proveedor]</label>";
                                        }
                                    ?>
                    ...
                    <br>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <a href="ver-marcas.php"><input type="button" class="btn" value="Ver" style = "width: 130px;"></a>
                                </div>
                                <div class="col">
