    ...
    ?>
        <div class="container">
            ...
            <div id="formcontainer">
                <form name="marcasproveedor" id="marcasproveedor" method="post" action="ver-marcasproveedor.php">
                    <div class="row">
                        <div class="col" style="font-size: 20px">SELECCIONE UNA MARCA:</div>
                        <div class="col">
                            <select name="marcas" id="marcas" style="height: 30px; width: 100%">
                                <option value="">
                                        <?php
                                            include("conexion.php");
