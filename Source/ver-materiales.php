...
<?php
    ...
    if($mat==1){//monitor
        ...
        echo"<div class='col'><h5>DAR DE BAJA</h5></div>";
        echo"</div>";
        ...
        echo"<div class='col'><a href='bor-materialesmonitor.php?ref=$linea[idreferencia]'><img src='./images/borrar.png' width='25'></a></div>";
        echo"</div>";  
        }
        ...
        echo"<div class='col'> <h5>USUARIO</h5> </div>";
        echo"<div class='col'> <h5>UBICACIÓN</h5> </div>";
        echo"<div class='col'> <h5>OBSERVACIONESv </div>";
        echo"<div class='col'> <h5>TIPO </h5></div>";
        ...
        echo"<div class='col'> <h5>GARANTIA</h5> </div>";
        echo"<div class='col'> <h5>ESTADO</h5> </div>";
        echo"<div class='col'><h5>DAR DE BAJA</h5>v</div>";
        echo"</div>";
        ...
        echo"<div class='col'>$linea[garantia]</div>";
        echo"<div class='col'>$linea[estado]</div>";
        echo"<div class='col'><a href='bor-materialesimpresora.php?ref=$linea[idreferencia]'><img src='./images/borrar.png' width='25'></a></div>";
        echo"</div>";  
        }
        ...
        echo"<div class='col'>$linea[garantia]</div>";
        echo"<div class='col'>$linea[estado]</div>";
        echo"<div class='col'><a href='bor-materialesordenador.php?ref=$linea[idreferencia]'><img src='./images/borrar.png' width='25'></a></div>";
        echo"</div>";  
        }
        ...
        echo"<div class='col'>$linea[ubicacion]</div>";
        echo"<div class='col'>$linea[observaciones]</div>";
        echo"<div class='col'><a href='bor-materiales.php?ref=$linea[idreferencia]'><img src='./images/borrar.png' width='25'></a></div>";
        echo"<hr style=\"background-color: WHITE; height: 3px;\"/>";
        echo"</div>";  
        }
