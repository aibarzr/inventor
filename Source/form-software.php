            ...
            <div id="formcontainer">
                <form name="software" id="software" method="post" action="ins-software.php">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-*-*">CODIGO DE LA LICENCIA:</div>
                            <div class="col-*-*"><input type="text" name="codigo" id="codigo"></div>
                        </div>
                        <div class="row">
                            <div class="col-*-*">CANTIDAD:</div>
                            <div class="col-*-*"><input type="number" name="cantidad" id="cantidad"></div>
                        </div>
                        <div class="row">
                            <div class="col-*-*">FECHA FIN:</div>
                            <div class="col-*-*"><input type="date" name="fechafin" id="fechafin"></div>
                        </div>
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-*-*">
                                    <a href="ver-software.php"><input type="button" class="btn" value="Ver"></a>
                                </div>
                                <div class="col-*-*">
